...
<form class="form" id="<?= $arParams["TOKEN"] ?>">
    <div class="form__columns">
        ...
        <div class="form__item form__item__sizehalf"><input class="form__input js--maskphone" type="tel" id="PHONE_<?= $arParams["TOKEN"] ?>" placeholder="Ваш телефон*" name="PHONE" /></div>
        <div class="form__item form__item__sizehalf"><input class="form__input" type="mail" placeholder="Ваш email*" name="EMAIL" /></div>
        <div class="form__item"><textarea class="form__input" placeholder="Введите сообщенние" rows="4" name="TEXT"></textarea></div>
        <div class="form__item"><button id="btn_<?= $arParams["TOKEN"] ?>" class="mbtn mbtn__primary mbtn__block" type="submit">Задать вопрос</button>
        ...
        <button id="send-btn_<?= $arParams["TOKEN"] ?>" style="display:none" class="mbtn mbtn__primary mbtn__small" data-fancybox-html="modal-send" data-src="#js--modal-send">Форма отправлена</button>
                    ...
                    <input type="text" hidden="" value="записаться на прием" name="TITLE">
    </div>
</form>
