...
<div class="modal" id="js--modal-recall">
        <div class="modal__content">
            ...
            <form class="form form__mini" id="<?= $arParams["TOKEN"] ?>">
                <div class="form__columns">
                    ...
                    <div class="form__item form__item__last"><button class="mbtn mbtn__primary mbtn__block" id="btn_<?= $arParams["TOKEN"] ?>" type="submit">Отправить</button>
                    ...
                    <input type="text" hidden="" value="обратный звонок" name="TITLE">
                </div>
            </form>
        </div>
    </div><!-- Modal sms send-->
