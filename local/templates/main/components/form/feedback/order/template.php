...
<div class="modal" id="js--modal-order">
        <div class="modal__content">
            <div class="modal__title">Записаться на прием</div>
            <form class="form form__mini" id="<?= $arParams["TOKEN"] ?>">
                <div class="form__columns">
                    ...
                    <div  class="form__item form__item__last">
                        <button id="btn_<?= $arParams["TOKEN"] ?>" type="submit" class="mbtn mbtn__primary mbtn__block">Записаться</button>
                        <div class="form__text"> Нажимая на кнопку, Вы соглашаетесь с <a href="/policy/">политикой конфиденциальности</a></div>
                    </div>
                   
                    <!-- <div class="form__item form__item__last"><button class="mbtn mbtn__primary mbtn__block" type="submit">Записаться</button>
                        <div class="form__text"> Нажимая на кнопку, Вы соглашаетесь с <a href="/policy/">политикой конфиденциальности</a></div>
                    </div> -->
